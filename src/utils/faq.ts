...
export function isFAQQuestion(message: string): string | null {
  ...
  if (
    ...
    messageLower.includes('admit') ||
    messageLower.includes('apply') ||
    messageLower.includes('application') ||
    messageLower.includes('प्रवेश') ||
    messageLower.includes('दाखला') ||
    messageLower.includes('दाखिला') ||
    messageLower.includes('दाखलो') ||
    messageLower.includes('आवेदन') ||
    messageLower.includes('अरजी')
  ) {
    return 'Admission';
  }
